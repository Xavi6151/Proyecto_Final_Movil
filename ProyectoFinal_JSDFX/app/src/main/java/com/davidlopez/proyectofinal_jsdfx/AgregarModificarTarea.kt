...
class AgregarModificarTarea : ComponentActivity() {
...
@Composable
fun DespliegueAgrModTarea(modifier: Modifier = Modifier, contentPadding: PaddingValues = PaddingValues(0.dp)){

}

@Composable
fun AgrModTarea(tareas: Tareas, modifier: Modifier = Modifier){
...
@Composable
fun appAgrModTarea(modifier: Modifier = Modifier){
    ...
    Scaffold(
        ...
        DespliegueAgrModTarea(contentPadding = it)
    }
}