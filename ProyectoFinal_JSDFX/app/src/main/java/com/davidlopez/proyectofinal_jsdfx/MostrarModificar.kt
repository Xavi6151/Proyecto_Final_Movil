...
@Composable
fun DespliegueMostrarModificar(modifier: Modifier = Modifier, contentPadding: PaddingValues = PaddingValues(0.dp)){
    LazyColumn(
        contentPadding=contentPadding,
        modifier = Modifier.padding(dimensionResource(id = R.dimen.padding_small))){
        items(DataSourceNotasTareas.texto){
            EditTextCard(content = it)
        }
    }
}
...
@Composable
fun EditTextCard(content: Content){
    TextField(
...
fun AppMostrarModificar(
    ...
    Scaffold(
                ...
                Row (
                    ...
                    IconButton(
                        onClick = {
                            ...
                            Toast.makeText(botonListo, "Nota modificada", Toast.LENGTH_SHORT).show() },
        ...
        bottomBar = {
            Column {
                ...
                Row (
                    ...
                    Button(
                        onClick = { Toast.makeText(botonMicrofono, "Microfono", Toast.LENGTH_SHORT).show() }
                    ) {
                        Box{
                            Image(
        ...
        DespliegueMostrarModificar(contentPadding = it)
    }
}